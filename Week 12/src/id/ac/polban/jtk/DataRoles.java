  ...
  void displayRoleDesc() {
    try {
      switch (EngRole) {
        case "Data Engineer":
          System.out.println(
              "Their core function is in the ingestion, structuring and standardization and processing of data. Their role has evolved quite a lot over the past few years and now involves dealing with both analytical and production systems.");
          break;
        ...
        case "Data Vizualization Engineer":
          System.out.println(
              "Data Vizualization Engineer make data looks beautiful. They typically work as part of a product team setting up dashboard within applications. They typically leverage Javascript for this purpose, using libraries such as D3js, VisGL and leafletJS.");
          break;
        case "Data Ops":
          System.out.println(
              "Data Ops help setup the data infrastructure, help handle code deployment, setup data quality checks and alerting & monitoring for the different flows.");
          break;
        default:
  ...
  void displayRoleDesc() {
    ...
    try {
      switch (ResRole) {
        ...
        case "Statistician":
          System.out.println(
              "Statisticians can help answer more complex questions with statistical rigour. This is the case in biostatistics where statisticians can help in designing and analyzing clinical trials and help provide the regulatory submissions.");
          break;
        case "Economist":
          System.out.println(
              "Economists work on leveraging data and economic theory for the good of companies. That can involve designing auction systems for ads, or working on predicting economic trends for risk assessment and capital allocation.");
          break;
        default:
...
class EngineerTools {
  ...
  void removeDataOpsTools() {
    try{
        ...
        this.EngTools.removeAll(this.DataOpsTools);
    }catch(AssertionError e){
